...
int main() {
    int num_contacts, month_list;
    int month = 12;
    num_contacts = getNum();
    struct contact contacts_list[num_contacts];
    struct contact contacts_december[num_contacts];
    readContacts(num_contacts, contacts_list);
    month_list = birthdayMonth(month, num_contacts, contacts_list, contacts_december);
    printList(month_list, contacts_december);   
}
